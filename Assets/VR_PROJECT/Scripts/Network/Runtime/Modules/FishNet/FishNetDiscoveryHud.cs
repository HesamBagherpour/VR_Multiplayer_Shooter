...
{
	public sealed class FishNetDiscoveryHud : MonoBehaviour
	{
		[SerializeField]
		private FishNetDiscovery networkDiscovery;
		...
		private void Start()
		{
			if (networkDiscovery == null) networkDiscovery = FindObjectOfType<FishNetDiscovery>();
